...
public class InvitationUnsubscribeManager {
    ...
    /**
     * 
     * @param connectionFactroyName -> This should be an existing factory like jms/WeltmeisterschaftFactory
     * @param topicConnectionName   -> This should be an existing topic like jms/WeltmeisterschaftTopic
     * @param subScriberId          -> This subscriberID will initialize the subscriber in the topic, so that when a durable publisher
     *                                 posts a message and the subscriber looks up with his ID he will get the 
     *                                 saved messages.
     */
