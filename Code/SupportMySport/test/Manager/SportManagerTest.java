...
public class SportManagerTest {
    ...
    @Test
    public void getSportsOfDepartmendTest() {
        PersistenceManager pm = new PersistenceManager();
        Department dep = (Department) pm.getObjectById(Department.class, 2);
        SportManager sm = new SportManager();
        Collection<Sport> sports = sm.getSportsOfDepartment(dep);
        System.out.println("");
        System.out.println("In getSportsOfDepartmend");
